  ...
  return (
    <nav className="fixed top-0 w-full z-50 bg-surface/40 backdrop-blur-xl dark:bg-[#0e0e10]/40 border-b border-white/10 shadow-[0_4px_30px_rgba(0,0,0,0.1)]">
      <div className="flex justify-between items-center max-w-7xl mx-auto px-6 py-4">
        <div className="text-2xl font-black tracking-tighter text-purple-400 dark:text-[#cc97ff] drop-shadow-[0_0_8px_rgba(168,85,247,0.5)] font-['Space_Grotesk'] uppercase">
          HACKMSIT
        </div>
